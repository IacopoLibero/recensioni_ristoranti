...
INSERT INTO `utente` (`id`, `username`, `password`, `nome`, `cognome`, `email`, `dataregistrazione`) VALUES
(1, 'ws', 'dfd', 'mario', 'dsddd', 'ighsiuhe@huhgqw.com', '2024-02-29 13:36:23');
...
--
ALTER TABLE `recensioni`
  MODIFY `IDRecensione` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
